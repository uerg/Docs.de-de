...
Weitere Informationen zum Konfigurieren von Regeln in der Windows-Firewall finden Sie unter [Konfigurieren von Firewallregeln](https://technet.microsoft.com/en-us/library/dd448559(WS.10).aspx). Firewalls von Drittanbietern finden Sie in der Produktdokumentation.
