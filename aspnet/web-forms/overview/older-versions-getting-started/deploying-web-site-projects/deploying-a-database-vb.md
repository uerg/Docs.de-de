...
[Herunterladen von Code](http://download.microsoft.com/download/E/6/F/E6FE3A1F-EE3A-4119-989A-33D1A9F6F6DD/ASPNET_Hosting_Tutorial_07_VB.zip) oder [PDF herunterladen](http://download.microsoft.com/download/C/3/9/C391A649-B357-4A7B-BAA4-48C96871FEA6/aspnet_tutorial07_DeployDB_vb.pdf)
...
[![Die Buch Reviews Web Application-s-Datenbank ist, besteht aus den vier Tabellen](deploying-a-database-vb/_static/image2.jpg)](deploying-a-database-vb/_static/image1.jpg) 

**Abbildung 1**: das Buch Reviews Web-s-Datenbank ist der vier Tabellen umfassen ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image3.jpg))
...
[![Die Seite "Genre" Technologie "](deploying-a-database-vb/_static/image5.jpg)](deploying-a-database-vb/_static/image4.jpg) 

**Abbildung 2**: die Technologie "Genre" Page ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image6.jpg))


[![Die Prüfung für Schulen selbst ASP.NET 3.5 in 24 Stunden](deploying-a-database-vb/_static/image8.jpg)](deploying-a-database-vb/_static/image7.jpg) 

**Abbildung 3**: die Prüfung für *Schulen selbst ASP.NET 3.5 in 24 Stunden* ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image9.jpg))
...
[![Suchen Sie die Datenbank in der Datenbank-Explorer oder den Server-Explorer](deploying-a-database-vb/_static/image11.jpg)](deploying-a-database-vb/_static/image10.jpg) 

**Abbildung 4**: Suchen Sie die Datenbank in der Datenbank-Explorer oder den Server-Explorer ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image12.jpg))
...
[![Der Datenbank, die Publishing Splash-Bildschirm des Assistenten](deploying-a-database-vb/_static/image14.jpg)](deploying-a-database-vb/_static/image13.jpg) 

**Abbildung 5**: die Datenbank Publishing-Assistent Begrüßungsbildschirm ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image15.jpg))
...
> [!NOTE]
> Wenn Sie die Fehlermeldung "Es sind keine Objekte in der Datenbank *DatabaseName* der Typen, die von diesem Assistenten haben" beim Klicken auf "weiter auf dem Bildschirm in Abbildung 6 dargestellten" Stellen Sie sicher, dass der Pfad der Datenbankdatei nicht übermäßig lange ist. Wie in notiert [dieses Diskussionselement](http://www.codeplex.com/sqlhost/Thread/View.aspx?ThreadId=11014) dieser Fehler kann auf der Seite der Datenbankveröffentlichungs-Assistent-Projekt haben, wenn der Pfad zur Datenbankdatei zu lang ist.


[![Der Datenbank, die Publishing Splash-Bildschirm des Assistenten](deploying-a-database-vb/_static/image17.jpg)](deploying-a-database-vb/_static/image16.jpg) 

**Abbildung 6**: die Datenbank Publishing-Assistent Begrüßungsbildschirm ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image18.jpg))
...
[![Skript für die Datenbank in eine Datei oder direkt in Ihren Webhostinganbieter veröffentlichen](deploying-a-database-vb/_static/image20.jpg)](deploying-a-database-vb/_static/image19.jpg) 

**Abbildung 7**: Skript für die Datenbank in eine Datei oder direkt in Ihren Webhostinganbieter veröffentlichen ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image21.jpg))
...
[![Geben Sie die Publishing Optionen](deploying-a-database-vb/_static/image23.jpg)](deploying-a-database-vb/_static/image22.jpg) 

**Abbildung 8**: Geben Sie die Publishing Optionen ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image24.jpg))
...
[![Herstellen einer Verbindung mit dem Web Host-Anbieter-s-Datenbankserver](deploying-a-database-vb/_static/image26.jpg)](deploying-a-database-vb/_static/image25.jpg) 

**Abbildung 9**: Herstellen einer Verbindung mit Ihren Webhostinganbieter s Datenbankserver ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image27.jpg))
...
[![Herstellen einer Verbindung mit dem Web Host-Anbieter-s-Datenbankserver](deploying-a-database-vb/_static/image29.jpg)](deploying-a-database-vb/_static/image28.jpg) 

**Abbildung 10**: Herstellen einer Verbindung mit Ihren Webhostinganbieter s Datenbankserver ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image30.jpg))
...
**Abbildung 11**: die Datenbank Objekte haben dupliziert wurde in der Produktionsdatenbank ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image33.jpg))
...
**Abbildung 12**: die Produktionsdatenbank enthält die gleichen Daten wie in der Entwicklungsdatenbank ([klicken Sie hier, um das Bild in voller Größe angezeigt](deploying-a-database-vb/_static/image36.jpg))
