...
ms.locfileid: "37399759"
---
<a name="deploying-your-site-using-visual-studio-c"></a>Bereitstellen einer Website mit Visual Studio (c#)
====================
...
**Abbildung 3**: Hinzufügen einer neuen Seite mit dem Namen `Privacy.aspx` zum Stammordner der Website ([klicken Sie, um das Bild in voller Größe anzeigen](deploying-your-site-using-visual-studio-cs/_static/image9.png))
