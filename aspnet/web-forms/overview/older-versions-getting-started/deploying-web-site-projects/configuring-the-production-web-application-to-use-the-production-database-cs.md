...
**Abbildung 3**: The Data-Driven-Anwendung ist jetzt verfügbar in Produktion! ([Klicken Sie, um das Bild in voller Größe anzeigen](configuring-the-production-web-application-to-use-the-production-database-cs/_static/image9.jpg))
