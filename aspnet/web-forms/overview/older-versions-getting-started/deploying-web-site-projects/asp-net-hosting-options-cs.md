...
Die Konfigurationsinformationen für eine Webanwendung befindet sich in der Regel der `Web.config` Datei, und enthält Datenbankverbindungszeichenfolgen, Fehlerbehandlung Kriterien, URL, die Regeln und e-Mail-Serverinformationen umschreiben. Häufig sind diese Informationen für eine Anwendung in der Entwicklung im Vergleich zu der gleichen Anwendung in der Produktion unterschiedlich. Beispielsweise sollte beim Entwickeln einer Anwendung eine Entwicklungsdatenbank verwenden, sodass Sie nicht gegen die Produktionsdatenbank testen. Folglich unterscheiden sich die Datenbank-Verbindungszeichenfolgen in der Regel zwischen Entwicklungs- und produktionsumgebungen Anwendungen. Aufgrund dieser Unterschiede auch Teil der Bereitstellung Änderungen an die Webanwendung-Konfigurationsinformationen.
