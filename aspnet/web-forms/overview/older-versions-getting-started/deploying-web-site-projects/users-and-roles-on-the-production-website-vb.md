...
([Klicken Sie hier, um das Bild in voller Größe angezeigt](users-and-roles-on-the-production-website-vb/_static/image6.png))
...
([Klicken Sie hier, um das Bild in voller Größe angezeigt](users-and-roles-on-the-production-website-vb/_static/image9.png))
...
([Klicken Sie hier, um das Bild in voller Größe angezeigt](users-and-roles-on-the-production-website-vb/_static/image12.png))
...
In der [ *Konfigurieren einer Website, dass verwendet Anwendungsdienste* Lernprogramm](configuring-a-website-that-uses-application-services-vb.md) ich hinzugefügt, dass eine Seite, um die `Admin` Ordner mit dem Namen `CreateAccount.aspx`. Auf dieser Seite können Sie einen Administrator ein neues Benutzerkonto mit dem Standort hinzufügen und angeben, ob der neu erstellte Benutzer in der Rolle "Admin" ist (siehe **Abbildung 5**).
...
([Klicken Sie hier, um das Bild in voller Größe angezeigt](users-and-roles-on-the-production-website-vb/_static/image15.png))
...
[Zurück](precompiling-your-website-vb.md)
