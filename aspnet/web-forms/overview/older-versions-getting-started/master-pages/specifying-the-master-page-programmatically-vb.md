...
**Abbildung 03**: Hinzufügen einer anderen Masterseite und CSS-Datei auf der Website ([klicken Sie, um das Bild in voller Größe anzeigen](specifying-the-master-page-programmatically-vb/_static/image9.png))
...
**Abbildung 06**: Inhaltsseiten werden angezeigt, unter Verwendung der `Site.master` Masterseite ([klicken Sie, um das Bild in voller Größe anzeigen](specifying-the-master-page-programmatically-vb/_static/image18.png))
...
**Abbildung 07**: Inhaltsseiten werden angezeigt, jetzt unter Verwendung der `Alternate.master` Masterseite ([klicken Sie, um das Bild in voller Größe anzeigen](specifying-the-master-page-programmatically-vb/_static/image21.png))
