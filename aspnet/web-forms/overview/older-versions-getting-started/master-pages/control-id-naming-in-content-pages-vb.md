...
ms.locfileid: "37808336"
---
<a name="control-id-naming-in-content-pages-vb"></a>Steuerelement-ID-Namen auf Inhaltsseiten (VB)
====================
...
**Abbildung 03**: die Seite enthält drei Web Controls: ein Textfeld, einer Schaltfläche und einer Bezeichnung ([klicken Sie, um das Bild in voller Größe anzeigen](control-id-naming-in-content-pages-vb/_static/image5.png))
...
**Abbildung 06**: der Benutzer-Agent wird angezeigt, in der Bezeichnung ([klicken Sie, um das Bild in voller Größe anzeigen](control-id-naming-in-content-pages-vb/_static/image12.png))
