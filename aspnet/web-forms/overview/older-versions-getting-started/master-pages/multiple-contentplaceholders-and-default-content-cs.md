...
**Abbildung 03**: die linke Spalte jetzt enthält seitenspezifische Inhalt unter der Abschnitt "News" ([klicken Sie, um das Bild in voller Größe anzeigen](multiple-contentplaceholders-and-default-content-cs/_static/image9.png))
...
**Abbildung 05**: kein Inhalt für gerendert wird die `LeftColumnContent` ContentPlaceHolder ([klicken Sie, um das Bild in voller Größe anzeigen](multiple-contentplaceholders-and-default-content-cs/_static/image15.png))
...
**Abbildung 07**: die Anmeldung Seite Represses der `QuickLoginUI` ContentPlaceHolder Standard Content ([klicken Sie, um das Bild in voller Größe anzeigen](multiple-contentplaceholders-and-default-content-cs/_static/image21.png))
