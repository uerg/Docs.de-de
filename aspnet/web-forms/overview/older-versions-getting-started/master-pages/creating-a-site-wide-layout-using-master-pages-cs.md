...
**Abbildung 09**: die Seite Inhalt des Design View zeigt sowohl den seitenspezifischen und Inhalt der Master-Seite ([klicken Sie, um das Bild in voller Größe anzeigen](creating-a-site-wide-layout-using-master-pages-cs/_static/image25.png))
...
**Abbildung 10**: finden Sie auf die `About.aspx` Seite über ein Browser ([klicken Sie, um das Bild in voller Größe anzeigen](creating-a-site-wide-layout-using-master-pages-cs/_static/image28.png))
