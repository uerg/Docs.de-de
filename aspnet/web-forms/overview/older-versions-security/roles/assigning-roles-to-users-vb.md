...
**Abbildung 1**: die Bezeichnung `CssClass` führt zu einer großen, Red-Schriftart ([klicken Sie, um das Bild in voller Größe anzeigen](assigning-roles-to-users-vb/_static/image3.png))
...
**Abbildung 10**: Hier ist ein Supervisor Tito!  ([Klicken Sie, um das Bild in voller Größe anzeigen](assigning-roles-to-users-vb/_static/image30.png))
...
**Abbildung 11**: Hinzufügen von "Geben Sie Roles" `WizardStep` auf die CreateUserWizard ([klicken Sie, um das Bild in voller Größe anzeigen](assigning-roles-to-users-vb/_static/image33.png))
