...
> [!NOTE]
> Die `selectedUserRoles.Contains<string>(...)` Syntax wird nicht kompiliert, wenn Sie ASP.NET Version 2.0 verwenden. Die `Contains<string>` Methode ist Teil der [LINQ-Bibliothek](http://en.wikipedia.org/wiki/Language_Integrated_Query), also noch nicht mit ASP.NET 3.5. Wenn Sie noch ASP.NET Version 2.0 verwenden, verwenden Sie die [ `Array.IndexOf<string>` Methode](https://msdn.microsoft.com/en-us/library/eha9t187.aspx) stattdessen.
