...
|           Domäne           | Bei Verwendung von Cookie-basierte Authentifizierungstickets wird mit dieser Einstellung Domänenwert für das Cookie. Der Standardwert ist eine leere Zeichenfolge, die bewirkt, dass der Browser die Domäne verwenden, von der aus (z. B. www.yourdomain.com) ausgestellt wurde. In diesem Fall das Cookie wird <strong>nicht</strong> gesendet werden, wenn Sie festlegen, dass untergeordnete Domänen, z. B. admin.yourdomain.com anfordert. Wenn Sie möchten das Cookie an alle Unterdomänen übergeben werden, Sie die Festlegung auf IhreDomäne.com Domänenattribut anpassen müssen. |
