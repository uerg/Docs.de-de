...
**Abbildung 4**: der Masterseite, wenn angezeigt durch das Design View ([klicken Sie, um das Bild in voller Größe anzeigen](an-overview-of-forms-authentication-cs/_static/image10.png))
...
**Abbildung 6**: Verwenden der Site.master-Masterseite
...
**Abbildung 7**: Wenn Ihr Projekt wird nicht noch enthalten "Web.config", fügen sie jetzt ([klicken Sie, um das Bild in voller Größe anzeigen](an-overview-of-forms-authentication-cs/_static/image17.png))
...
**Abbildung 10**: die InvalidCredentialsMessage-Bezeichnung ist, ungültige Anmeldeinformationen angezeigt, bei der Eingabe ([klicken Sie, um das Bild in voller Größe anzeigen](an-overview-of-forms-authentication-cs/_static/image26.png))
...
**Abbildung 12**: authentifizierten Benutzern wird gezeigt, dass der "Willkommen zurück". Meldung
...
Starten, indem ein ContentPlaceHolder-Objekt mit dem Namen "LoginContent", in die Masterseite innerhalb der Navigation hinzufügen &lt;Div&gt; Element. Können Sie einfach ein ContentPlaceHolder-Steuerelement ziehen, aus der Toolbox auf die Datenquellensicht, platzieren das daraus resultierende Markup direkt über den "TODO: Menü werden hier..." Text.
...
**Abbildung 15**: das LoginView-Steuerelement zeigt "Willkommen zurück, Jisun."
