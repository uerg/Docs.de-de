...
eine Zeichenfolge CurrentUsersName = User.Identity.Name;
...
- [Die `<authentication>` Element](https://msdn.microsoft.com/en-us/library/532aee0e.aspx)
- [Die `<forms>` -Element`<authentication>`](https://msdn.microsoft.com/en-us/library/1d3t3c61.aspx)
