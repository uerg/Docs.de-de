...
**Abbildung 5**: Konfigurieren der Foreign Key-Einschränkung auf Sie Löschweitergaben ([klicken Sie, um das Bild in voller Größe anzeigen](storing-additional-user-information-cs/_static/image15.png))
...
**Abbildung 9**: der Spalten aus den Wert bringen wieder alle die `UserProfiles` Tabelle ([klicken Sie, um das Bild in voller Größe anzeigen](storing-additional-user-information-cs/_static/image27.png))
...
**Abbildung 11**: Inhalt der `aspnet_Users` und `UserProfiles` Tabellen werden angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](storing-additional-user-information-cs/_static/image33.png))
...
**Abbildung 12**: A-Datensatz wurde hinzugefügt, um `UserProfiles` für Bruce ([klicken Sie, um das Bild in voller Größe anzeigen](storing-additional-user-information-cs/_static/image36.png))
...
**Abbildung 17**: sehen Sie die Gästebuch-Kommentare in der `GuestbookComments` Tabelle ([klicken Sie, um das Bild in voller Größe anzeigen](storing-additional-user-information-cs/_static/image51.png))
...
**Abbildung 20**: ein neues Benutzerkonto an, und `UserProfiles` Datensatz hinzugefügt wurden ([klicken Sie, um das Bild in voller Größe anzeigen](storing-additional-user-information-cs/_static/image60.png))
