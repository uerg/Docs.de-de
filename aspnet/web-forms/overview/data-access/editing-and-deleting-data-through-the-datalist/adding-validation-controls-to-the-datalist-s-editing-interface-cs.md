...
**Abbildung 6**: die Validierungsfehler werden in einer Client-Side-Messagebox zusammengefasst ([klicken Sie, um das Bild in voller Größe anzeigen](adding-validation-controls-to-the-datalist-s-editing-interface-cs/_static/image18.png))
