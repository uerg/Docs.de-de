...
**Abbildung 2**: das sortierbare GridView s, die Daten nach Kategorie sortiert werden ([klicken Sie, um das Bild in voller Größe anzeigen](creating-a-customized-sorting-user-interface-cs/_static/image6.png))
...
**Abbildung 6**: die Kopfzeilen von Gruppen sortieren sind fehlende beim Sortieren einer CheckBoxField ([klicken Sie, um das Bild in voller Größe anzeigen](creating-a-customized-sorting-user-interface-cs/_static/image16.png))
...
**Abbildung 7**: die Kopfzeilen von Gruppen sortieren sind jetzt vorhanden beim Sortieren einer CheckBoxField ([klicken Sie, um das Bild in voller Größe anzeigen](creating-a-customized-sorting-user-interface-cs/_static/image19.png))
