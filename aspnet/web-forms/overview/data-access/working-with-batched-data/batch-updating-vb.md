...
Zunächst erfolgt ein Aufruf zum `BatchUpdate`. Als Nächstes wird die [ `ClientScript` Eigenschaft](https://msdn.microsoft.com/en-us/library/system.web.ui.page.clientscript(VS.80).aspx) wird verwendet, um JavaScript einfügen, die eine MessageBox-Datenbank, die gelesen angezeigt werden, die Produkte wurden aktualisiert.
