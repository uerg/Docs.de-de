...
**Abbildung 5**: Abbildung 5: Konfigurieren von dem ObjectDataSource-Steuerelement verwenden die `ProductsBLL` s-Klasse `GetProducts` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](wrapping-database-modifications-within-a-transaction-cs/_static/image4.png))
...
**Abbildung 8**: der Produkte in einer navigierbaren GridView-Ansicht angezeigt werden ([klicken Sie, um das Bild in voller Größe anzeigen](wrapping-database-modifications-within-a-transaction-cs/_static/image10.png))
