...
**Abbildung 5**: der GridView Vorlagen können werden bearbeitet über das Verwenden des Designers ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-gridview-control-vb/_static/image15.png))
...
**Abbildung 6**: Hinzufügen eines Websteuerelements Bezeichnung, um die `FirstName` TemplateFields ItemTemplate ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-gridview-control-vb/_static/image18.png))
...
**Abbildung 10**: ersten und den Nachnamen jedes Mitarbeiters werden in einer Spalte angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-gridview-control-vb/_static/image30.png))
...
**Abbildung 14**: die Mitarbeiters `HiredDate` sehen Sie in das Kalender-Steuerelement ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-gridview-control-vb/_static/image42.png))
...
**Abbildung 15**: Hinzufügen einer neuen TemplateField an die GridView ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-gridview-control-vb/_static/image45.png))
...
**Abbildung 16**: die Anzahl von Tagen der Mitarbeiter wurde für den Auftrag angezeigt wird ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-gridview-control-vb/_static/image48.png))
