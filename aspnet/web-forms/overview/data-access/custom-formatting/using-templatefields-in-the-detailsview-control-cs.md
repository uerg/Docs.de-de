...
**Abbildung 3**: die Produkt-Details werden angezeigt, mit einer Reihe von BoundFields ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-detailsview-control-cs/_static/image9.png))
...
**Abbildung 6**: der Preis und Inventar TemplateField zeigt die Kosten ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-detailsview-control-cs/_static/image18.png))
...
**Abbildung 8**: die Preis- und Bestandsdaten in einer einzelnen Zeile angezeigt wird ([klicken Sie, um das Bild in voller Größe anzeigen](using-templatefields-in-the-detailsview-control-cs/_static/image24.png))
