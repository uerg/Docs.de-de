...
**Abbildung 2**: das FormView-Steuerelement nicht gerendert werden, in den Designer an, bis ein `ItemTemplate` bereitgestellt wird ([klicken Sie, um das Bild in voller Größe anzeigen](using-the-formview-s-templates-cs/_static/image6.png))
...
**Abbildung 3**: die starren DetailsView Output ([klicken Sie, um das Bild in voller Größe anzeigen](using-the-formview-s-templates-cs/_static/image9.png))
...
**Abbildung 4**: die fließende FormView Output ([klicken Sie, um das Bild in voller Größe anzeigen](using-the-formview-s-templates-cs/_static/image12.png))
