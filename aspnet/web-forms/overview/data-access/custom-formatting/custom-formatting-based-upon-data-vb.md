...
**Abbildung 7**: für Produkte mit einer ausreichend großen Units In Stock, die keine benutzerdefinierte Formatierung angewendet wird ([klicken Sie, um das Bild in voller Größe anzeigen](custom-formatting-based-upon-data-vb/_static/image17.png))
...
**Abbildung 8**: der Einheiten im Lager Anzahl wird für diese Produkte mit Werten von 10 oder weniger in Rot angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](custom-formatting-based-upon-data-vb/_static/image20.png))
...
**Abbildung 11**: die meisten kostengünstige-Produkte befinden sich in gelb hervorgehoben ([klicken Sie, um das Bild in voller Größe anzeigen](custom-formatting-based-upon-data-vb/_static/image27.png))
