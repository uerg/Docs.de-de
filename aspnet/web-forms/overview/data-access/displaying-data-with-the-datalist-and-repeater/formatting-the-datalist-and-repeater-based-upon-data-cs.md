...
**Abbildung 1**: der Produkte finden Sie in das DataList-Steuerelement ([klicken Sie, um das Bild in voller Größe anzeigen](formatting-the-datalist-and-repeater-based-upon-data-cs/_static/image3.png))
...
**Abbildung 3**: das gesamte Produkt-Element wird für die Produkte unter 20,00 $pro hervorgehoben ([klicken Sie, um das Bild in voller Größe anzeigen](formatting-the-datalist-and-repeater-based-upon-data-cs/_static/image9.png))
