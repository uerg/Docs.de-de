...
**Abbildung 3**: Kopieren von deklarativen Markup `UploadInDetailsView.aspx` ([klicken Sie, um das Bild in voller Größe anzeigen](updating-and-deleting-existing-binary-data-cs/_static/image6.png))
...
**Abbildung 4**: Konfigurieren von dem ObjectDataSource-Steuerelement verwenden die `DeleteCategory` Methode ([klicken Sie, um das Bild in voller Größe anzeigen](updating-and-deleting-existing-binary-data-cs/_static/image8.png))
...
**Abbildung 6**: Hinzufügen einer Testkategorie mit einem Broschüre und Image ([klicken Sie, um das Bild in voller Größe anzeigen](updating-and-deleting-existing-binary-data-cs/_static/image12.png))
...
**Abbildung 11**: GridView verfügt nicht über eine Bearbeiten-Schnittstelle für `BrochurePath` ([klicken Sie, um das Bild in voller Größe anzeigen](updating-and-deleting-existing-binary-data-cs/_static/image20.png))
...
**Abbildung 14**: zunächst mit aktuellen Broschüre ausgewählt ist ([klicken Sie, um das Bild in voller Größe anzeigen](updating-and-deleting-existing-binary-data-cs/_static/image24.png))
