...
ms.locfileid: "37807751"
---
<a name="including-a-file-upload-option-when-adding-a-new-record-vb"></a>Einschließlich der einer Dateiuploadoption beim Hinzufügen eines neuen Datensatzes (VB)
====================
...
**Abbildung 4**: Sie sollten jetzt finden Sie unter jeder Kategorie zusammen mit einem Binärdaten ([klicken Sie, um das Bild in voller Größe anzeigen](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image8.png))
...
**Abbildung 10**: Bild nicht angezeigt wird, die neue Kategorie-s ([klicken Sie, um das Bild in voller Größe anzeigen](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image18.png))
