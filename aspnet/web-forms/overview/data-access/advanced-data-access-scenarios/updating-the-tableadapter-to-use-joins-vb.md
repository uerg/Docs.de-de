...
ms.locfileid: "37377171"
---
<a name="updating-the-tableadapter-to-use-joins-vb"></a>Aktualisieren den TableAdapter, für die Verwendung von Verknüpfungen (VB)
====================
...
**Abbildung 6**: Benennen der TableAdapter s gespeicherte Prozeduren ([klicken Sie, um das Bild in voller Größe anzeigen](updating-the-tableadapter-to-use-joins-vb/_static/image14.png))
...
**Abbildung 8**: der TableAdapter Insert enthält, Update- und Delete-Funktionen ([klicken Sie, um das Bild in voller Größe anzeigen](updating-the-tableadapter-to-use-joins-vb/_static/image20.png))
...
**Abbildung 9**: die Ergebnisse für gespeicherte Prozeduren werden im Ausgabefenster angezeigt ([klicken Sie, um das Bild in voller Größe anzeigen](updating-the-tableadapter-to-use-joins-vb/_static/image23.png))
...
**Abbildung 12**: Konfigurieren von dem ObjectDataSource-Steuerelement verwenden die `EmployeesBLLWithSprocs` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](updating-the-tableadapter-to-use-joins-vb/_static/image32.png))
...
**Abbildung 13**: haben Sie die Verwendung von "ObjectDataSource" die `GetEmployees` und `DeleteEmployee` Methoden ([klicken Sie, um das Bild in voller Größe anzeigen](updating-the-tableadapter-to-use-joins-vb/_static/image35.png))
