...
**Abbildung 5**: Benennen der `GetData` Methode, um `GetSuppliers` ([klicken Sie, um das Bild in voller Größe anzeigen](working-with-computed-columns-cs/_static/image15.png))
...
**Abbildung 11**: Konfigurieren von dem ObjectDataSource-Steuerelement verwenden die `SuppliersBLLWithSprocs` Klasse ([klicken Sie, um das Bild in voller Größe anzeigen](working-with-computed-columns-cs/_static/image33.png))
...
**Abbildung 12**: jede Lieferanten finden Sie im Raster ([klicken Sie, um das Bild in voller Größe anzeigen](working-with-computed-columns-cs/_static/image36.png))
