...
**Abbildung 11**: die GridView zeigt jedes Produkt s `ProductID`, `ProductName`, und `UnitPrice` Werte ([klicken Sie, um das Bild in voller Größe anzeigen](querying-data-with-the-sqldatasource-control-vb/_static/image17.gif))
...
**Abbildung 15**: s der GridView zeigt jede Produkt-ID, Name und Kategorienamen verknüpft ist ([klicken Sie, um das Bild in voller Größe anzeigen](querying-data-with-the-sqldatasource-control-vb/_static/image23.gif))
