...
**Abbildung 4**: Zurückgeben nur diejenigen Produkte kleiner als oder gleich dem Parameterwert ([klicken Sie, um das Bild in voller Größe anzeigen](using-parameterized-queries-with-the-sqldatasource-cs/_static/image8.png))
...
**Abbildung 6**: keine Datensätze werden angezeigt, wenn die `MaxPrice` Textfeld ist leer ([klicken Sie, um das Bild in voller Größe anzeigen](using-parameterized-queries-with-the-sqldatasource-cs/_static/image12.png))
...
**Abbildung 8**: jetzt alle Produkte sind, angezeigt, wenn die `MaxPrice` Textfeld ist leer ([klicken Sie, um das Bild in voller Größe anzeigen](using-parameterized-queries-with-the-sqldatasource-cs/_static/image16.png))
...
**Abbildung 13**: Name angezeigt wird, der nach dem Zufallsprinzip ausgewählten Kategorie-s ([klicken Sie, um das Bild in voller Größe anzeigen](using-parameterized-queries-with-the-sqldatasource-cs/_static/image26.png))
...
**Abbildung 14**: Geben Sie keine Parameter-Quelle oder Default Value ([klicken Sie, um das Bild in voller Größe anzeigen](using-parameterized-queries-with-the-sqldatasource-cs/_static/image28.png))
...
**Abbildung 15**: Geben Sie keine Parameter-Quelle oder Default Value ([klicken Sie, um das Bild in voller Größe anzeigen](using-parameterized-queries-with-the-sqldatasource-cs/_static/image30.png))
