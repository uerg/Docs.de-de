...
Ein Design, das auf eine bestimmte Anwendung spezifisch ist befindet sich in einem `App\_Themes\<Theme\_Name>` Verzeichnis im Stammverzeichnis der Website.
...
Anwendungsspezifische Designs können nur auf die Anwendung angewendet werden, in denen die Dateien befinden. Diese Dateien befinden sich der `App\_Themes/<theme\_name>` Verzeichnis im Stammverzeichnis der Website.
