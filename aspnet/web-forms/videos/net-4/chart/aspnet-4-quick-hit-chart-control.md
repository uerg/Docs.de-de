...
---
<a name="aspnet-4-quick-hit---chart-control"></a>ASP.NET 4 "Schnelles erreicht" - Diagramm-Steuerelement
====================
durch [Joe Stagner](https://github.com/JoeStagner)

In diesem Video erfahren Sie, wie das Diagrammsteuerelement für ASP.NET zu verwenden, um das Erstellen von einfachen, intuitiven und grafisch anspruchsvollen Diagrammen. 

[&#9654;Sehen Sie sich an (2 Minuten)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-chart-control)
