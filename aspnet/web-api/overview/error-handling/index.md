...
====================
> Behandeln von Ausnahmen in ASP.NET Web-API.


- [Ausnahmebehandlung in Web-API](exception-handling.md)
- [Globale Fehlerbehandlung in Web-API 2](web-api-global-error-handling.md)
