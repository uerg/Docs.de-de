...
Wenn Sie es vorziehen, verwenden [Microsoft JSON-Datumsformat](https://msdn.microsoft.com/en-us/library/bb299886.aspx#intro_to_json_sidebarb) (`"\/Date(ticks)\/"`) statt ISO 8601, setzen die **DateFormatHandling** Eigenschaft auf die serialisierereinstellungen:
