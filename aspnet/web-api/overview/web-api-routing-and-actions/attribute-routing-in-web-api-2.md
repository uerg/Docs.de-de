...
3. Bei einem gleichwertigen Objekt werden Routen nach einem Ordinalzeichenfolgenvergleich sortiert ([OrdinalIgnoreCase](https://msdn.microsoft.com/library/system.stringcomparer.ordinalignorecase.aspx)) für die routenvorlage.
