...
- Legen Sie zum Aktivieren der Browserlink `debug=true` in der [ &lt;Kompilierung&gt; ](https://msdn.microsoft.com/en-us/library/s10awwz0(v=vs.85).aspx) Element in der Datei Web.config des Projekts.
