...
ms.locfileid: "37364092"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="f464a-102">ASP.NET Web Forms und Ajax 4</span><span class="sxs-lookup"><span data-stu-id="f464a-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="f464a-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="f464a-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="f464a-104">Hinweis: Die Globalisierung von Skripts wie z.B. "fr"-FR.js, können in folgendem Ordner befinden:</span><span class="sxs-lookup"><span data-stu-id="f464a-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
