...
ms.locfileid: "30072914"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="486fa-102">JQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="486fa-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="486fa-103">Die folgenden Dateien für die jQuery DataTables-Plug-Ins, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="486fa-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
