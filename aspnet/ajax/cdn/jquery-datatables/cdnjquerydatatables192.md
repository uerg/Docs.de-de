...
ms.locfileid: "30071355"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="b2961-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="b2961-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="b2961-103">Die folgenden Dateien für die jQuery DataTables-Plug-Ins, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="b2961-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
