...
ms.locfileid: "30071232"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="53f24-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="53f24-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="53f24-103">Die folgenden Dateien für die jQuery DataTables-Plug-Ins, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="53f24-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
