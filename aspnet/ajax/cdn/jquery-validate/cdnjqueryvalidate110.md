...
---
<a name="jquery-validation-1100"></a><span data-ttu-id="62765-102">jQuery-Validierung 1.10.0</span><span class="sxs-lookup"><span data-stu-id="62765-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="62765-103">Die folgenden Dateien, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="62765-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="62765-104">Lokalisierung Dateien am https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages \_## js, in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="62765-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
