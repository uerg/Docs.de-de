...
ms.locfileid: "30078010"
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="71939-102">jquery.validate version 1.8.1</span><span class="sxs-lookup"><span data-stu-id="71939-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="71939-103">Die folgenden Dateien, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="71939-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="71939-104">Lokalisierung Dateien am https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages \_## js, in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="71939-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
