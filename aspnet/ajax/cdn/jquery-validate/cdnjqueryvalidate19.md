...
ms.locfileid: "30070874"
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="acb2a-102">jquery.validate version 1.9</span><span class="sxs-lookup"><span data-stu-id="acb2a-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="acb2a-103">Die folgenden Dateien, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="acb2a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="acb2a-104">Lokalisierung Dateien am https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages \_## js, in denen ## ist der Code für die Lokalisierung.</span><span class="sxs-lookup"><span data-stu-id="acb2a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
