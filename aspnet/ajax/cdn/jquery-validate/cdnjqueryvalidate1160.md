...
ms.locfileid: "37834357"
---
<a name="jquery-validation-1160"></a><span data-ttu-id="ea358-102">jQuery-Validierung 1.16.0</span><span class="sxs-lookup"><span data-stu-id="ea358-102">jQuery Validation 1.16.0</span></span>
====================
<span data-ttu-id="ea358-103">Die folgenden Dateien, die für das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="ea358-103">The following files are hosted on the CDN:</span></span>
