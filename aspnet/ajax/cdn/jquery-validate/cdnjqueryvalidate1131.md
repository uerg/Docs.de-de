...
====================
<span data-ttu-id="dd9dd-103">Die folgenden Dateien, die auf das CDN gehostet werden:</span><span class="sxs-lookup"><span data-stu-id="dd9dd-103">The following files are hosted on the CDN:</span></span>
