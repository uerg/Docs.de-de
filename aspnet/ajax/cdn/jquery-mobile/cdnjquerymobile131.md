...
ms.locfileid: "30071615"
---
<a name="jquery-mobile-131-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="d6a0e-102">jQuery Mobile 1.3.1 auf das Microsoft Ajax-CDN</span><span class="sxs-lookup"><span data-stu-id="d6a0e-102">jQuery Mobile 1.3.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="d6a0e-103">Die jQuery Mobile 1.3.1-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="d6a0e-103">The jQuery Mobile 1.3.1 library includes the following files:</span></span>
