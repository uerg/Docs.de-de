...
ms.locfileid: "37801630"
---
<a name="jquery-mobile-140-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="feeb3-102">jQuery Mobile 1.4.0 für das Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="feeb3-102">jQuery Mobile 1.4.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="feeb3-103">JQuery Mobile 1.4.0-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="feeb3-103">The jQuery Mobile 1.4.0 library includes the following files:</span></span>
