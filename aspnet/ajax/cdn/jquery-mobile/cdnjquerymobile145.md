...
ms.locfileid: "37826626"
---
<a name="jquery-mobile-145-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="dbcef-102">jQuery Mobile 1.4.5 für das Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="dbcef-102">jQuery Mobile 1.4.5 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="dbcef-103">JQuery Mobile 1.4.5-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="dbcef-103">The jQuery Mobile 1.4.5 library includes the following files:</span></span>
