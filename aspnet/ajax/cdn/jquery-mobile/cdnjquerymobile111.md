...
ms.locfileid: "37362232"
---
<a name="jquery-mobile-111-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="107fe-102">jQuery Mobile 1.1.1 für das Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="107fe-102">jQuery Mobile 1.1.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="107fe-103">JQuery Mobile 1.1.1-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="107fe-103">The jQuery Mobile 1.1.1 library includes the following files:</span></span>
