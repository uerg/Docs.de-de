...
ms.locfileid: "37829822"
---
<a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="c587e-102">jQuery Mobile 1.4.1 für das Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="c587e-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="c587e-103">JQuery Mobile 1.4.1-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="c587e-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
