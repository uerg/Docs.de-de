...
ms.locfileid: "37829599"
---
<a name="jquery-mobile-112-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="928e3-102">jQuery Mobile 1.1.2 für das Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="928e3-102">jQuery Mobile 1.1.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="928e3-103">JQuery Mobile 1.1.2-Bibliothek enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="928e3-103">The jQuery Mobile 1.1.2 library includes the following files:</span></span>
