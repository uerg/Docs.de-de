...
ms.locfileid: "30078152"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="0ba30-102">jQuery-Vorlagen Beta 1</span><span class="sxs-lookup"><span data-stu-id="0ba30-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="0ba30-103">Die jQuery-Vorlagen-Plug-in enthält die folgenden Dateien:</span><span class="sxs-lookup"><span data-stu-id="0ba30-103">The jQuery Templates plugin includes the following files:</span></span>
