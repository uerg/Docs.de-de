...
**Abbildung 01**: Dialogfeld "Neues Projekt" ([klicken Sie hier, um das Bild in voller Größe angezeigt](understanding-models-views-and-controllers-vb/_static/image2.png))
...
**Abbildung 02**: Einheit Testdialogfeld erstellen ([klicken Sie hier, um das Bild in voller Größe angezeigt](understanding-models-views-and-controllers-vb/_static/image4.png))
...
**Abbildung 03**: das Fenster des Projektmappen-Explorer ([klicken Sie hier, um das Bild in voller Größe angezeigt](understanding-models-views-and-controllers-vb/_static/image6.png))
...
**Abbildung 04**: Dialogfeld Debuggen nicht aktiviert ([klicken Sie hier, um das Bild in voller Größe angezeigt](understanding-models-views-and-controllers-vb/_static/image8.png))
...
[![Die Seite "Index"](understanding-models-views-and-controllers-vb/_static/image5.jpg)](understanding-models-views-and-controllers-vb/_static/image9.png)

**Abbildung 05**: die Indexseite ([klicken Sie hier, um das Bild in voller Größe angezeigt](understanding-models-views-and-controllers-vb/_static/image10.png))
...
Ein Controller ist nur eine Klasse (z. B. eine Visual Basic- oder C#-Klasse). Das Beispiel ASP.NET MVC-Anwendung enthält einen Controller mit dem Namen HomeController.vb im Ordner "Controller". Der Inhalt der Datei HomeController.vb ist im Codebeispiel 2 reproduziert.
