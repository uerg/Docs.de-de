...
**Abbildung 01**: das neue Projektdialogfeld ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image2.png))
...
**Abbildung 02**: Dialogfeld für das Komponententestprojekt erstellen ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image4.png))
...
**Abbildung 03**: der Projektmappen-Explorer-Fenster ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image6.png))
...
**Abbildung 05**: der Datenbank-Tabellen-Designer ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image10.png))
...
**Abbildung 06**: Dialogfeld für das neue Element in einer hinzufügen ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image12.png))
...
**Abbildung 09**: Datenbankobjekte auswählen ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image18.png))
...
**Abbildung 13**: die Ansicht der hinzufügen-Dialogfeld ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image26.png))
...
**Abbildung 15**: der Index-Ansicht ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image30.png))
...
Html.ActionLink ({Id = Element. ID der}) %&gt;
...
**Abbildung 21**: indizieren Sie die Sicht mit dem Link "Bearbeiten" ([klicken Sie, um das Bild in voller Größe anzeigen](iteration-1-create-the-application-cs/_static/image42.png))
