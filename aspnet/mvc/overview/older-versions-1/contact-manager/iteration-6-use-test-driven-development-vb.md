...
**Abbildung 01**: Hinzufügen von den Komponententest GroupControllerTest ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image2.png))
...
**Auflisten von 2 – Controllers\GroupController.vb**

[!code-vb[Main](iteration-6-use-test-driven-development-vb/samples/sample2.vb)]

**3 – Models\Group.vb auflisten**
...
[![War erfolgreich!](iteration-6-use-test-driven-development-vb/_static/image2.jpg)](iteration-6-use-test-driven-development-vb/_static/image3.png)

**Abbildung 02**: Erfolg! () [Klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image4.png))
...
**4 – Controllers\GroupControllerTest.vb auflisten**
...
**5 – Controllers\GroupController.vb auflisten**
...
**6 – Controllers\GroupControllerTest.vb auflisten**
...
**Auflisten von 9 – Controllers\GroupController.vb**
...
**Auflisten von 11 - Controllers\FakeContactManagerRepository.vb**
...
**12 - Controllers\GroupControllerTest.vb auflisten**
...
[![Erstellen eine datenbankbeziehung-Tabelle](iteration-6-use-test-driven-development-vb/_static/image3.jpg)](iteration-6-use-test-driven-development-vb/_static/image5.png)

**Abbildung 03**: Erstellen einer Datenbank-tabellenbeziehung ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image6.png))
...
**Abbildung 04**: Angeben von tabellenbeziehungen ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image8.png))
...
[![Aktualisieren ein Modell im Entity Framework aus der Datenbank](iteration-6-use-test-driven-development-vb/_static/image5.jpg)](iteration-6-use-test-driven-development-vb/_static/image9.png)

**Abbildung 05**: Aktualisieren eines Entity Framework-Datenmodells aus der Datenbank ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image10.png))
...
[![Entitätsdesigner zum Anzeigen von Gruppen und wenden Sie sich an](iteration-6-use-test-driven-development-vb/_static/image6.jpg)](iteration-6-use-test-driven-development-vb/_static/image11.png)

**Abbildung 06**: Entity Designer zum Anzeigen von Group und Contact ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image12.png))
...
**Auflisten von 14 - Models\IContactManagerRepository.vb**

[!code-vb[Main](iteration-6-use-test-driven-development-vb/samples/sample14.vb)]

Wir noch nicht tatsächlich eine der Methoden im Zusammenhang mit dem Arbeiten mit wenden Sie sich an Gruppen in der echte EntityContactManagerRepository-Klasse implementiert. Gegenwärtig kann die Klasse EntityContactManagerRepository Stubmethoden für jede Gruppe von Kontakten Methoden aufgeführt, die in der IContactManagerRepository-Schnittstelle. Beispielsweise sieht die ListGroups() Methode derzeit wie folgt:
...
**Auflisten von 13 - Models\EntityContactManagerRepository.vb**
...
**Abbildung 07**: die Gruppe Indexansicht ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image14.png))
...
[![Die Kontakt-Indexansicht](iteration-6-use-test-driven-development-vb/_static/image8.jpg)](iteration-6-use-test-driven-development-vb/_static/image15.png)

**Abbildung 08**: die Indexansicht Kontakt ([klicken Sie hier, um das Bild in voller Größe angezeigt](iteration-6-use-test-driven-development-vb/_static/image16.png))
