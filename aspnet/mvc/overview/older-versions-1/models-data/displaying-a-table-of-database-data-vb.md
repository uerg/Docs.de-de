...
**Abbildung 03**: die Controller-Menü hinzufügen ([klicken Sie, um das Bild in voller Größe anzeigen](displaying-a-table-of-database-data-vb/_static/image6.png))
...
**Abbildung 04**: die Controller der hinzufügen-Dialogfeld ([klicken Sie, um das Bild in voller Größe anzeigen](displaying-a-table-of-database-data-vb/_static/image8.png))
...
**Abbildung 06**: die Ansicht der hinzufügen-Dialogfeld ([klicken Sie, um das Bild in voller Größe anzeigen](displaying-a-table-of-database-data-vb/_static/image12.png))
