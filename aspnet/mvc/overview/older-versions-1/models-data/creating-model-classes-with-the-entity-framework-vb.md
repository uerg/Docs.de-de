...
ms.locfileid: "37810403"
---
<a name="creating-model-classes-with-the-entity-framework-vb"></a>Erstellen von Modellklassen mit dem Entitätsframework (VB)
====================
...
Die \_Db-Feld wird innerhalb der Index()-Aktion zum Abrufen der Datensätze aus der Tabelle der Datenbank Filme verwendet. Der Ausdruck \_Db. MovieSet stellt alle Datensätze aus der Tabelle der Datenbank Filme dar. Die ToList()-Methode wird verwendet, um den Satz von Filmen in eine generische Auflistung von Movie-Objekten zu konvertieren: Liste (Of Movie).
