...
**Abbildung 1**: ermitteln den Verarbeitungsmodus für die Anforderung ([klicken Sie, um das Bild in voller Größe anzeigen](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image2.png))
...
**Abbildung 2**: Empfangen von Fehler 404 nicht gefunden ([klicken Sie, um das Bild in voller Größe anzeigen](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.png))
