...
**Abbildung 1**: Erkennen des Anforderung erforderliche Modus ([klicken Sie hier, um das Bild in voller Größe angezeigt](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image2.png))
...
**Abbildung 2**: Empfangen von Fehler 404 Nichtgefunden ([klicken Sie hier, um das Bild in voller Größe angezeigt](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image4.png))
...
Wichtig: Denken Sie daran, Ihre ASP.NET MVC-Anwendung erstellen, nach Ändern der Datei "Global.asax" erneut.
...
**Abbildung 3**: erstellen eine Zuordnung mit Platzhalterzeichen Skript mit IIS 7.0 ([klicken Sie hier, um das Bild in voller Größe angezeigt](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image6.png))
...
**Abbildung 4**: erstellen eine Zuordnung mit Platzhalterzeichen Skript mit IIS 6.0 ([klicken Sie hier, um das Bild in voller Größe angezeigt](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image8.png))
...
**Abbildung 5**: fehlende Route stammfehler ([klicken Sie hier, um das Bild in voller Größe angezeigt](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image10.png))
