...
<span data-ttu-id="4a89f-251">In der **Ansicht** Menü klicken Sie auf **Server-Explorer**.</span><span class="sxs-lookup"><span data-stu-id="4a89f-251">In the **View** menu, click **Server Explorer**.</span></span>
