...
4. In der **neue Microsoft Azure-Clouddienst** wählen Sie im Dialogfeld **ASP.NET-Webrolle** , und wählen Sie die  **&gt;**  Schaltfläche, um die Rolle zum Projekt hinzuzufügen. Klicken Sie auf **OK**.
...
10. Kopieren der *signalr.exe* Datei (hinzugefügt, mit der **Microsoft.AspNet.SignalR.Utils** Paket) von  **&lt;Projektordner&gt;\SignalRPerfCounters\packages\ Microsoft.AspNet.SignalR.Utils. &lt;Version&gt;\tools** auf die *Start* Ordner, die Sie im vorherigen Schritt erstellt haben.
...
12. Mit der rechten Maustaste auf die *Start* neu erstellten Ordner. Wählen Sie **hinzufügen &gt; neues Element**. Wählen Sie die **allgemeine** Knoten **Textdatei**, und nennen Sie das neue Element *SignalRPerfCounterInstall.cmd*. Diese Befehlsdatei installiert SignalR-Leistungsindikatoren in der Rolle "Web".
...
21. Erstellen eines neuen Ordners in der **WebRole1** Projekt mit dem Namen *Hubs*. Mit der rechten Maustaste die *Hubs* Ordner im **Projektmappen-Explorer**Option **Web &gt; SignalR**, und wählen Sie **SignalR-Hub-Klasse (v2)**. Name des neuen Hubs *MyHub.cs* , und wählen Sie **hinzufügen**.
