...
* [Microsoft Azure SDK für Visual Studio](https://azure.microsoft.com/downloads/) **Hinweis: Starten Sie Ihren Computer nach der Installation des SDK neu.**
...
2. Wählen Sie in Visual Studio **Datei** > **neu** > **Projekt**.
