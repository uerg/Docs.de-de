...
Wenn Sie Ihre Anwendung in Azure bereitstellen, sollten Sie mit der Redis-Rückwandplatine mit [Azure Redis Cache](https://azure.microsoft.com/en-us/services/cache/). Wenn Sie mit Ihren eigenen Serverfarm bereitstellen, sollten Sie die SQL Server- oder Redis Backplanes.
