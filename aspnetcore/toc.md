...
### [Erstellen einer Web-API unter macOS](xref:tutorials/first-web-api-mac)
...
## [Introduction (Einführung)](xref:signalr/introduction-signalr-core)
## [Erste Schritte](xref:signalr/get-started-signalr-core)
