...
---
# <a name="create-a-web-app-with-aspnet-core-mvc-using-visual-studio-on-windows"></a>Erstellen einer Web-App mit ASP.NET Core MVC und Visual Studio unter Windows

Diese Tutorialreihe vermittelt Ihnen die Grundlagen zum Erstellen einer ASP.NET Core MVC-Web-App mithilfe von Visual Studio. [!INCLUDE[consider RP](../../includes/razor.md)]
