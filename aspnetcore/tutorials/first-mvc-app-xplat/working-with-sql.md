...
<span data-ttu-id="3f38c-104">[Zurück: Hinzufügen eines Modells](adding-model.md)
[Weiter: Controllermethoden und Ansichten](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="3f38c-104">[Previous - Add a model](adding-model.md)
