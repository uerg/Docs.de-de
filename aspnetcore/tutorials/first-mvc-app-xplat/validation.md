...
<span data-ttu-id="ede0a-103">[Zurück: Hinzufügen eines Felds](new-field.md)
[Weiter: Untersuchen der Methoden „Details“ und „Delete“](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="ede0a-103">[Previous - Add a field](new-field.md)
