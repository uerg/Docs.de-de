...
> <span data-ttu-id="2a9da-103">[Zurück: Arbeiten mit SQLLite](xref:tutorials/razor-pages-mac/sql)
> [Hinzufügen der Suche](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="2a9da-103">[Previous: Work with SQLlite](xref:tutorials/razor-pages-mac/sql)
