...
> <span data-ttu-id="fb6e6-103">[Zurück: Hinzufügen eines Modells](xref:tutorials/razor-pages-vsc/model)
> [Weiter: Aktualisieren der Seiten](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="fb6e6-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
