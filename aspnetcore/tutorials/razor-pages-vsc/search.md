...
> <span data-ttu-id="3c451-103">[Zurück: Aktualisieren der Seiten](xref:tutorials/razor-pages-vsc/da1)
> [Weiter: Hinzufügen eines neuen Felds](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="3c451-103">[Previous: Updating the pages](xref:tutorials/razor-pages-vsc/da1)
