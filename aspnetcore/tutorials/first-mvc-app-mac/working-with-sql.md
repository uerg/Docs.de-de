...
> <span data-ttu-id="44f71-103">[Zurück: Hinzufügen eines Modells](adding-model.md)
> [Weiter: Controllermethoden und Ansichten](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="44f71-103">[Previous - Add a model](adding-model.md)
