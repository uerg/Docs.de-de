...
keywords: ASP.NET Core,Validierung,DataAnnotations
ms.author: riande
manager: wpickett
ms.date: 06/13/2017
...
<span data-ttu-id="7b4d2-104">[Zurück: Hinzufügen eines Felds](new-field.md)
[Weiter: Untersuchen der Methoden „Details“ und „Delete“](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="7b4d2-104">[Previous - Add a field](new-field.md)
