...
Fügen Sie dem Ordner *Modelle* die folgende *MovieContext.cs*-Klasse hinzu: [!code-csharp[](../../tutorials/razor-pages/razor-pages-start/snapshot_sample/RazorPagesMovie/Models/MovieContext.cs)]
