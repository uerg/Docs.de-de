...
Verhindert das automatische Laden der Hostingstartassemblys, einschließlich denen, die von der Assembly der App konfiguriert wurden. Weitere Informationen finden Sie unter [Enhance an app from an external assembly (Erweitern einer App über eine externe Assembly)](xref:fundamentals/configuration/platform-specific-configuration).
