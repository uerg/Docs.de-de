...
Weitere Informationen finden Sie unter [Verwenden von Kestrel mit einem Reverseproxy](xref:fundamentals/servers/kestrel#when-to-use-kestrel-with-a-reverse-proxy).
