...
Über die `Session`-Eigenschaft von `HttpContext` wird auf die Sitzung zugegriffen. Bei der Eigenschaft handelt es sich um eine [ISession](/dotnet/api/microsoft.aspnetcore.http.isession)-Implementierung.
