...
* Verwenden Sie den Identity-UI-2.0-Code, ohne Änderungen. Mithilfe der Identity-UI-2.0-Code wird vollständig unterstützt. Dies ist ein guter Ansatz, wenn es sich bei dem generierten Code für die Identität niederwertigste-Änderungen vorgenommen wurden.
...
* Löschen der Identität gerüstbauer generiert `IdentityDbContext` abgeleitete Klasse in der *Bereiche/Identity/Data/* Ordner.
...
* Update der *_LoginPartial.cshtml* Datei:
  ...
  * Hinzufügen `asp-area="Identity"` auf die Form und Achor Links.
