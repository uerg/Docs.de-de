...
> [!NOTE] Da es kein Domänencontroller für die Stamm-URL definiert ist, zeigt der Browser Fehler 404 (Seite nicht gefunden). Dabei handelt es sich um ein erwartetes Verhalten.
...
### <a name="test-the-web-api-withoutauthentication"></a>Testen Sie die Web-API-withoutauthentication
