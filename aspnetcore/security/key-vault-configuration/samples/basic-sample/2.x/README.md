# <a name="key-vault-configuration-provider-sample-application-aspnet-core-2x"></a>Key Vault-Konfigurationsanbieter-beispielanwendung (ASP.NET Core 2.x)

Dieses Beispiel veranschaulicht die Verwendung von Azure Key Vault-Konfigurationsanbieter für ASP.NET Core 2.x. Das ASP.NET Core 1.x-Beispiel finden Sie unter [Konfigurationsanbieter für Key Vault-beispielanwendung (ASP.NET Core 1.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/key-vault-configuration/samples/basic-sample/1.x).
