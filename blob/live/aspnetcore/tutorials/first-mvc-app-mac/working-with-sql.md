...
<span data-ttu-id="fde33-104">[Zurück: Hinzufügen eines Modells](adding-model.md)
[Weiter: Controllermethoden und Ansichten](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="fde33-104">[Previous - Add a model](adding-model.md)
